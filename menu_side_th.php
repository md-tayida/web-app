...
<header>
    ...
    <div class="main-nav">
       <div class='box-back'> 
        ...
        <div class='box-2'>     <a href="menu_ramyeon_th.php" class="main-btn">รสชาติรามยอน</a></div>
           <div class='box-1'> <a href="menu_side_th.php" class="main-btn-1">เครื่องเคียง</a></div>
...
<a href="select_side_th.php?sideDishes_id=<?php echo $row['sideDishes_id']; ?>">
