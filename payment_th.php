 ...
 <script>
        ...
        window.onload = function () {
            ...
            setTimeout(function () {
                ...
                window.location.href = 'back_to_index_th.php';
            }, countdownTime);
        ...
        function updateTimer() {
            ...
            document.getElementById('timer').innerText = `ชำระเงินภายใน: ${minutes}:${seconds < 10 ? '0' : ''}${seconds}`;
        }
    </script>
...
<body>
    ...
    <div class="timmer-des">
        <h2 id="timer">ชำระเงินภายใน: 5.00</h2>
    </div>
    <div class="pay-by-QR">
    <?php  if(isset($_SESSION['payment']) && $_SESSION['payment'] === 'พร้อมเพย์') {
         // Print "a" if payment is by card
   ?>
        <div class="qr-forPay-contanier">
        <div class="title-inSum">
            <span class='back-menu'>
                        <a href="select_payment_th.php" ><i class="bi bi-chevron-left"></i></a>
            ...
            <form action="confirmed_payment_th.php" method="post">
    <button class="paymentConfirm" type="submit" name="confirmed_payment"><span class="text">ยืนยันการชำระเงิน</span></button>
</form>
            </div>
        </div>
        <?php  } elseif(isset($_SESSION['payment']) && $_SESSION['payment'] === 'บัตรเครดิต') {
        // Print "a" if payment is by card
    ?>
     <div class="qr-forPay-contanier">
     <div class="title-inSum">
    ...
    <button class="paymentConfirm" type="submit" name="confirmed_payment">
        <span class="text">ยืนยันการชำระเงิน</span></button>
</form>
