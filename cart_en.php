...
<?php 
    ...
    foreach ($_SESSION["cart"] as $key => $item) {
        ...
        if (!empty($item['drink_id'])){
            ...
            echo "    <form action='update_quantity_en.php' method='post'>";
            ...
            echo "    <form action='delete_item_en.php' method='post'>";
            echo "        <input type='hidden' name='indexes' value='" . $key . "'>";
       ...
       <li><h5>{$ramyeon_name}</h5>";
        ...
        if (!empty($item['toppings'])) {
            ...
            foreach ($item['toppings'] as $topping_id) {
                ...
                echo "<li>{$topping_row['topping_name_en']} ({$topping_price}฿)</li>";
            }
            echo "</ul>";
        }
...
echo "</div>";
        ...
        <div class="col-md-12 summary-inSum">
            ...
            <form action='select_payment_en.php' method='post' >
