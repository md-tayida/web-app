        ...
        <section class="sec-custom">
            <div class="custom-topping-detail">
                <div class="row">
                    ...
                    <div class='back-menu'>
                        <a href="menu_side_th.php" ><i class="bi bi-chevron-left"></i></a>
                                </div> <br>
...
<script>
    function updateTotalPrice(checkbox) {
        ...
        totalPrice *= quantity;
        document.getElementById('totalPrice').innerText = 'Total Price: ' + ราคาทั้งหมด + '฿';
    }
</script>
                            ...
                            <h4>จำนวน</h4>
                            <form action='add_to_cart_th2.php' method='post'>
                            <div class="qty" >
    ...
    function incrementQuantity() {
        ...
        if (currentQuantity < maxQuantity) {
            ...
            alert('คุณไม่สามารถเพิ่มจำนวนสินค้าเกิน ' + maxQuantity + ' ได้');
                            ...
                            <br>
                            <div class="cal-price">
                                <h5 id='totalPrice'>ราคาทั้งหมด: <?php echo $sideDishes_price; ?>฿</h5>
