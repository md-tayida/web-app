  ...
  <script>
        ...
        window.onload = function () {
            ...
            setTimeout(function () {
                ...
                window.location.href = 'index_th.php';
            }, countdownTime);
...
<body>
    ...
    if(isset($_SESSION['order_id'])) {
        ...
        <h2 id="timer">ไปยังหน้าเริ่มต้นภายใน: 1.00</h2>
    </div>
    ...
    ?>
    <p><strong>ประเภท:</strong> <?php echo $row['eat_location']; ?></p>
    <p><strong>วันที่:</strong>  <?php echo $row['order_date']; ?></p>
    <p><strong>เวลา:</strong>  <?php echo $row['order_time']; ?></p>
    <p><strong>ประเภทการชำระเงิน:</strong> <?php echo $row['payment_method']; ?></p>
</div>
<hr>
   ...
   <li><h6><b>{$ramyeon_name}</b></h6>";
    ...
    if (!empty($item['toppings'])) {
        ...
        foreach ($item['toppings'] as $topping_id) {
            ...
            echo "<li><h6>{$topping_row['topping_name_th']}</h6></li>";
        }
        echo "</ul>";
    }
...
<hr>
        <div class="total-price-inRecipt">
            ...
            <div>
    <h4><b><?php echo intval($row['total_price']); ?><span>&#3647;</span></b></h4>
</div>
    ...
    <div class="btn-to-restart">
        <button class="to-restart-page" onclick="window.location.href='index_th.php'">
            <span class="text">ไปยังหน้าเริ่มต้น</span>
        </button>
    </div>
