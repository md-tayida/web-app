...
<header>
    ...
    <div class="main-nav">
       <div class='box-back'> 
        ...
        <div class='box-1'>     <a href="menu_ramyeon_en.php" class="main-btn-1">RAMYEONS</a></div>
...
<a href="select_topping_en.php?ramyeon_id=<?php echo $row['ramyeon_id']; ?>">
