    ...
    <div class="main-nav">
       <div class='box-back'> 
        ...
        <div class='box-2'>     <a href="menu_ramyeon_th.php" class="main-btn">รสชาติรามยอน</a></div>
           ...
           <div class='box-1'> <a href="menu_drink_th.php" class="main-btn-1">เครื่องดื่ม</a> </div>
        <div class="line">
            <hr>
        </div>
    </nav>
...
<a href="select_drink_th.php?drink_id=<?php echo $row['drink_id']; ?>">
