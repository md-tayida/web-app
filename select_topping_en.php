        ...
        <section class="sec-custom">
            <div class="custom-topping-detail">
                <div class="row">
                    ...
                    <div class='back-menu'>
                        <a href="menu_ramyeon_en.php" ><i class="bi bi-chevron-left"></i></a>
                                </div> <br>
...
{$row1['topping_name_en']} ({$row1['topping_price']}฿)</label>"; ?>
                        ...
                        <?php }  }  ;
                          ...
                          echo  "<br><h4>Vegetable</h4>";   if(mysqli_num_rows($result2) > 0) {
                            // Display the toppings as checkboxes
...
{$row2['topping_name_en']} ({$row2['topping_price']}฿)</label>"; 
                            }
                  }      } ?>
<script>
    ...
    function incrementQuantity() {
        ...
        if (currentQuantity < maxQuantity) {
            ...
            alert('คุณไม่สามารถเพิ่มจำนวนสินค้าเกิน ' + maxQuantity + ' ได้');
                            ...
                            <br>
                            <div class="cal-price">
                                <h5 id='totalPrice'>Total Price: <?php echo $ramyeon_price; ?>฿ </h5>
